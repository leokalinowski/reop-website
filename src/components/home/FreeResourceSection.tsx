          ...
          <div className="space-y-6 mb-12">
            {resources.map((resource, index) => (
              <motion.div
                ...
                className="flex items-start gap-4 bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border hover:border-primary/30 transition-colors min-h-[100px]"
              >
