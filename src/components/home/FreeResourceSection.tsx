      ...
      <section ref={ref} className="section-padding bg-gradient-to-br from-primary/5 via-background to-accent/5 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <motion.div 
            ...
            className="text-center mb-8 sm:mb-12 space-y-4 px-4"
          >
          ...
          <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-12 px-4">
            {resources.map((resource, index) => (
              <motion.div
                ...
                className="flex items-start gap-3 sm:gap-4 bg-card/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-border hover:border-primary/30 transition-colors"
              >
                <div className="flex-shrink-0">
                  <CheckCircle2 className="w-5 h-5 sm:w-7 sm:h-7 text-accent" />
                </div>
                <div>
          ...
          >
            <Button 
              ...
              size="lg"
              className="text-sm sm:text-base md:text-lg h-12 sm:h-14 md:h-16 px-6 sm:px-8 md:px-12 shadow-xl hover:shadow-2xl transition-all duration-300 w-full sm:w-auto"
            >
